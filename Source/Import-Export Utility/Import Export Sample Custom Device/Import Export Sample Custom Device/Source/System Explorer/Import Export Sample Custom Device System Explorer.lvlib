		...
		<Item Name="Dynamically Called" Type="Folder">
			<Item Name="Extra Pages" Type="Folder">
				<Item Name="RTM" Type="Folder">
					<Item Name="Export Custom Device Configuration.vi" Type="VI" URL="../Extra Pages/RTM/Export Custom Device Configuration.vi"/>
				</Item>
				<Item Name="Sample Channel.vi" Type="VI" URL="../Extra Pages/Sample Channel.vi"/>
			</Item>
